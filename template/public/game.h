...
class Chess : public Game {
 ...
 protected:
  void Start() override {
    std::cout << "Starting a game of chess with " << number_of_players_
              << " players\n";
  }

  bool HaveWinner() override { return turns_ == max_turns_; }
  ...
  int GetWinner() override { return current_player_; }
